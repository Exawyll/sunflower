...
class HoleListFragment : Fragment() {
    ...
    private val viewModel: HoleListViewModel by viewModels {
        InjectorUtils.provideHoleListViewModelFactory(this)
    }
    ...
    override fun onCreateView(
        ...
        val binding = FragmentHoleListBinding.inflate(inflater, container, false)
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        inflater.inflate(R.menu.menu_hole_list, menu)
    }
    ...
    private fun subscribeUi(adapter: HoleAdapter) {
